...
class NoseHoover(MolecularDynamics):
    ...
    def increment_temperature(self, dt):
        self.reset_temperature(self.T/units.kB+dt)
    ...
    def run(self, steps=None):
        ...
        # print("NoseHoover loop steps: ", epochs)

        for s in tqdm(range(epochs)):
            # print("inside NVT loop ", s)
...
class Langevin(MolecularDynamics):
    ...
    def increment_temperature(self, dt):
        self.reset_temperature(self.T+dt)
